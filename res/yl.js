window.YL = {
  info: {
    ...
    iconBtnStart: 'scribd',
    author: 'Seikka',
    contactInformation: 'seikka@seikka.xyz',
    officialWebsite: 'https://seikka.52msr.cn',
    copyrightDetail: 'SeOS官方测试产品。禁止任何未经授权的使用、修改、二次发布，包括从本产品中剥离SeOS独立使用等侵权行为，违者将追究法律责任。',
    otherStatements: '',
  },
  data: {},
  lang: function (key) {
