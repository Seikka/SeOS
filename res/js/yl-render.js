    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("YLUI v" + YL.info.version + " 测试版", '当前SeOS为测试版，仅限个人用户测试使用，禁止商用及企业使用。<br/>更多信息及获取商业授权请访问:<br/>SeOS官网：' + '<a style="color: white" target="_blank" href="http://se.52msr.cn">http://se.52msr.cn</a>');
            }, 1500)
          });
        }
